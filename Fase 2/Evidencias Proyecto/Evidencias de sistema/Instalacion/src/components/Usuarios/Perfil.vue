<template>
  <div>
      ...
      <div class="hero-body">
        <div class="level">
          ...
          <div class="level-item is-hero-content-item">
            <div>
              <h1 class="title is-spaced white-text">Perfil de {{ nombreUsuario }}</h1>
            </div>
          </div>
          <div class="level-right">
            <div class="level-item">
              <b-button
                class="custom-button is-large"
                size="is-large"
                icon-left="lock"
                tag="router-link"
                to="/cambiar-password"
    ...
    <!-- Sección de columnas eliminada, que contenía gráficos de ventas -->
    <div class="columns is-desktop">
      <!-- Aquí se eliminó la tarjeta de "Tus ventas de la semana" -->
      <!--
      ...
      <!-- Aquí se eliminó la tarjeta de "Tus ventas del mes" -->
      <!--
      <div class="column is-one third">
        <div class="card">
          <header class="card-header">
      ...
      <!-- Aquí se eliminó la tarjeta de "Tus ventas del año" -->
      <!--
      <div class="column is-one third">
        <div class="card">
          <header class="card-header">
    ...
    obtenerDatos() {
      ...
      HttpService.obtenerConDatos(this.filtros, "perfil.php").then(
        (resultado) => {
          ...
          this.ventasAnio = Utiles.cambiarNumeroANombreMes(resultado.ventasAnio);
          this.totalVentasAnio = Utiles.calcularTotales(this.ventasAnio);

          // Se eliminaron las llamadas para generar gráficos
          /*
...
.custom-button {
  background-color: #dd20bb; /* Color de fondo */
...
.custom-button:hover {
  background-color: #36a471; /* Color de fondo al pasar el ratón */
