...
$crear_bd = "CREATE DATABASE IF NOT EXISTS cafealasproyecto";
...
$conexion->exec('USE cafealasproyecto');
#Ahora crear las tablas
//$conexion->close();

$conexion = new PDO("mysql:host=$host;dbname=cafealasproyecto", $usuario, $password);
$conexion->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
